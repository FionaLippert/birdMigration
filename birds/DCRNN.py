...
class EncoderModel(nn.Module):
    def __init__(self, adj_mx, **model_kwargs):
        ...
        self.input_dim = int(model_kwargs.get('input_dim', 10))
        self.seq_len = int(model_kwargs.get('seq_len', 5))
        self.max_diffusion_step = int(model_kwargs.get('max_diffusion_step', 1))
        self.num_nodes = int(model_kwargs.get('num_nodes', 22))
        self.filter_type = model_kwargs.get('filter_type', 'laplacian')
        self.num_rnn_layers = int(model_kwargs.get('num_rnn_layers', 2))
        self.hidden_state_size = int(model_kwargs.get('hidden_state_size', 32))
